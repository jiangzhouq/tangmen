...
public class HandlerUfpExample extends BaseSinglePaneActivity {
	...
	public  class HandlerExampleFragment extends Fragment{
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			exchangeDataService3.setTemplate(1);
			
			ExchangeViewManager exchangeViewManager = new ExchangeViewManager(mContext, exchangeDataService3);
			
			GridTemplateConfig config = new GridTemplateConfig().setNumColumns(4).setMaxPsize(20);
			exchangeViewManager.setGridTemplateConfig(config);
			
			exchangeViewManager.addView(ExchangeConstants.type_list_curtain, relayout1);
